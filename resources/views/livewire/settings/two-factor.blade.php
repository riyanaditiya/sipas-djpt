<section class="w-full">
    ...
    <x-settings.layout :heading="__('Otentikasi Dua Faktor')" :subheading="__('Kelola pengaturan otentikasi dua faktor Anda')">
        <div class="flex flex-col w-full mx-auto space-y-6 text-sm" wire:cloak>
            @if ($twoFactorEnabled)
                <div class="space-y-4">
                    ...
                    <flux:text>
                        {{ __('Dengan otentikasi dua faktor yang aktif, Anda akan diminta memasukkan PIN acak yang aman saat login, yang dapat Anda ambil dari aplikasi pendukung TOTP di ponsel Anda.') }}
                    </flux:text>
            ...
            @if ($showVerificationStep)
                <div class="space-y-6">
                    <div class="flex flex-col items-center space-y-3 justify-center">
                        <flux:otp name="code" wire:model="code" length="6" label="Kode OTP" label:sr-only
                            class="mx-auto" />
                    </div>
