<div>
    ...
    <section class="bg-white dark:bg-gray-900 rounded-lg shadow p-6 mt-6">
        ...
        <form wire:submit.prevent="save" class="space-y-5">
           ...
           w-[110px] h-[42px]
           text-sm font-medium text-white bg-[#0576a6] hover:bg-[#0054A3] rounded-lg focus:ring-4 focus:ring-yellow-200
           disabled:opacity-70 disabled:cursor-not-allowed
           dark:focus:ring-yellow-900">

                    {{-- TEXT --}}
                    <span wire:loading.remove wire:target="save" class="absolute">
                        Simpan
                    </span>

                    {{-- SPINNER --}}
                    <svg wire:loading wire:target="save" class="absolute w-5 h-5 animate-spin text-white"
